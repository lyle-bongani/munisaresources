...
const ContactSection: React.FC = () => {
  return (
    <section className="w-full bg-white flex flex-col items-center justify-center mt-10 mb-8">
      {/* Background Image */}
      <div className="w-full h-[420px] overflow-hidden relative flex justify-center">
        <img
          src={process.env.PUBLIC_URL + '/pics/contactsectionhome.jpg'}
          alt="Contact Section Background"
          className="w-full h-full object-cover object-center"
        />
      </div>
      {/* Card */}
      <div className="w-[95vw] max-w-4xl min-h-[480px] bg-white rounded-2xl shadow-lg flex flex-col md:flex-row p-10 md:p-16 mt-[-160px] z-10 relative">
        {/* Left: Contact Info */}
